...
class ORPOTrainer(Trainer):
    ...
    def __init__(
        ...
        with PartialState().local_main_process_first():
            ...
            chosen_labels = train_dataset['chosen_labels']
            chosen_input_ids = train_dataset['chosen_input_ids']
            temp = train_dataset['chosen_labels'] == train_dataset['chosen_input_ids']
    ...
    def concatenated_inputs(
        ...
        for k in batch:
            if k.startswith("chosen") and isinstance(batch[k], torch.Tensor) and k != 'chosen_images':
        ...
        for k in batch:
            if k.startswith("rejected") and isinstance(batch[k], torch.Tensor) and k != 'rejected_images':
                if "labels" in k or is_encoder_decoder:
                    pad_value = label_pad_token_id
                elif k.endswith("_input_ids"):
                    pad_value = padding_value
    ...
    def concatenated_forward(
        ...
        concatenated_batch['images'] = torch.cat(images)
